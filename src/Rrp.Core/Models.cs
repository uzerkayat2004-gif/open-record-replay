...
public sealed record RrpWorkflow(
    string ApiVersion,
    string Kind,
    WorkflowMetadata Metadata,
    WorkflowRequirements Requires,
    IReadOnlyDictionary<string, WorkflowParameter> Parameters,
...
public sealed record WorkflowStep(
    ...
    IReadOnlyList<WorkflowAssertion>? Preconditions,
    IReadOnlyList<WorkflowAssertion>? Postconditions,
